...
export default dealOfDay = (props) => {
  ...
  const fetchNewArrivals = async () => {
    const apiUrl = `https://rxj4xi-xa.myshopify.com/admin/api/2023-01/products.json?collection_id=509442654510`;
  ...
  return (
    <View>
      <View style={[styles.headerView, { flexDirection: viewRTLStyle }]}>
        <Text style={[styles.offerCorner, { color: props.colors.text, fontWeight: 'bold', fontSize:20, }]}>
          {'Öne Çıkanlar'}
        </Text>
        <TouchableOpacity
          onPress={() => {
